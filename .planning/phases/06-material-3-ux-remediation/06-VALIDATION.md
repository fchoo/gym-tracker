...
| 06-09-02 | 09 | 3 | UX-01..UX-10 | T-06-01..T-06-03 | Full gates and unchanged private signed candidate bytes bind C1-C11 and N1-N3 reports | full + native | `PHASE6_MANIFEST_SHA256=$(node -e "const m=require('./artifacts/release-candidate/build.json'); process.stdout.write(m.manifest_sha256)") && npm run test:maestro:phase6 -- --bundle-dir artifacts/release-candidate --manifest-sha256 "$PHASE6_MANIFEST_SHA256" --package com.fchoo.gymtracker --serial emulator-5554 --output artifacts/release-candidate/evidence/phase6.json --report-dir artifacts/release-candidate/evidence/maestro` after `npm run test:all -- --runInBand` | ❌ Wave 3 candidate evidence | ⬜ pending |
| 06-09-03 | 09 | 3 | UX-01..UX-10 | T-06-01..T-06-03 | N4 Samsung observations remain exact-byte and cannot authorize release | attended | Observation-only Phase 6 checklist validation | ❌ Wave 3 checklist | ⬜ pending |
