...
| RC-02-LATEST-SCHEMA-ADD-COPY | D-64 | G-02-05 | 02-27-SUMMARY.md | `src/ui/__tests__/ActiveWorkoutScreen.test.tsx#adds warm-ups and confirms removal only through the trusted removal port`; `tests/integration/complete-set.test.ts#Plan 07-02 receipt-backed hard removal` | 02-34 latest-schema add/reused-value/removal native flow | samsung-physical | implemented_host_verified_evidence_pending |
...
| RC-02-SET-STATUS | D-59 | G-02-04 | 02-28-SUMMARY.md | `src/ui/__tests__/ActiveWorkoutScreen.test.tsx#uses separate warm-up commands and excludes them from working progress`; `src/ui/__tests__/ActiveWorkoutScreen.test.tsx#adds warm-ups and confirms removal only through the trusted removal port`; `src/ui/__tests__/ActiveWorkoutScreen.test.tsx#adds working sets and leaves rows unchanged until confirmed removal commits` | 02-34 completed/current/planned status and incomplete-row removal flow | emulator-supplementary, samsung-physical | implemented_host_verified_evidence_pending |
...
| RC-02-WARMUP-EXCLUSION-COPY | D-59 | G-02-04 | 02-28-SUMMARY.md | `src/ui/__tests__/ActiveWorkoutScreen.test.tsx#uses separate warm-up commands and excludes them from working progress`; `src/ui/__tests__/ActiveWorkoutScreen.test.tsx#adds warm-ups and confirms removal only through the trusted removal port`; `tests/integration/complete-set.test.ts#Plan 07-02 receipt-backed hard removal` | 02-34 warm-up domain exclusion and add/remove flow | emulator-supplementary, samsung-physical | implemented_host_verified_evidence_pending |

`RC-02-LATEST-SCHEMA-ADD-COPY` and `RC-02-WARMUP-EXCLUSION-COPY` remain
stable historical IDs for cross-artifact joins. Their current observations follow
the Phase 7 Add-reuses-previous-values and Remove-row contract; the retired
separate duplication control is not part of the current evidence claim.
...
| D-59 | RC-02-SET-STATUS, RC-02-WARMUP-EXCLUSION-COPY | 02-28-SUMMARY.md | Plan 02-28 set-state, removal, and warm-up-exclusion tests | 02-34 status and warm-up add/remove flow; emulator-supplementary then samsung-physical |
...
| D-64 | RC-02-LATEST-SCHEMA-ADD-COPY, RC-02-RETRY-FOCUS | 02-27-SUMMARY.md; 02-28-SUMMARY.md | Plans 02-27/02-28 schema and UI mutation tests | 02-34 add/reused-value/removal flow; emulator-supplementary for retry/focus and samsung-physical for mutation/correction |
...
| G-02-04 | RC-02-GLYPH-ACTION-GEOMETRY, RC-02-SET-STATUS, RC-02-WARMUP-EXCLUSION-COPY | 02-28-SUMMARY.md | Plan 02-28 geometry/status tests | 02-34 glyph, status, and warm-up add/remove flow; emulator-supplementary then samsung-physical |
| G-02-05 | RC-02-LATEST-SCHEMA-ADD-COPY, RC-02-RETRY-FOCUS | 02-27-SUMMARY.md; 02-28-SUMMARY.md | Plans 02-27/02-28 mutation tests | 02-34 add/reused-value/removal flow; emulator-supplementary for retry/focus and samsung-physical for mutation/correction |
