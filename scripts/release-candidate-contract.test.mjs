...
test("emulator-runner commands are self-contained on one line", () => {
  ...
  assert.deepEqual(scriptLines, [
    ...
    'npm run test:maestro:phase7 -- --bundle-dir artifacts/release-candidate --manifest-sha256 "${{ steps.candidate_manifest.outputs.manifest_sha256 }}" --package com.fchoo.gymtracker --serial emulator-5554 --output artifacts/release-candidate/evidence/phase7.json --report-dir artifacts/release-candidate/evidence/phase7-maestro',
