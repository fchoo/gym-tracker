...
export const PHASE7_CONSIDERATION_CONTRACTS = Object.freeze([
  ...
  Object.freeze({ id: "UX-13", owner: "07-01 Settings route", automated_checks: Object.freeze(["src/ui/__tests__/TodayScreen.test.tsx", "tests/test_routes.py"]), flows: Object.freeze(["phase7-today-settings", "phase7-icon-navigation-accessibility"]), native_backstops: Object.freeze(["UI-B05"]) }),
  ...
  Object.freeze({ id: "UX-16", owner: "07-02 compact SetRow", automated_checks: Object.freeze(["src/ui/components/SetRow.test.tsx" ]), flows: Object.freeze(["phase7-workout-removal-audio"]), native_backstops: Object.freeze(["UI-B03"]) }),
  ...
  Object.freeze({ id: "UX-18", owner: "07-02 authoritative removal", automated_checks: Object.freeze(["src/domains/workout/setCommands.test.ts", "src/platform/sqlite/repositories/workoutRepository.test.ts" ]), flows: Object.freeze(["phase7-workout-removal-audio"]), native_backstops: Object.freeze(["UI-B01"]) }),
  ...
  Object.freeze({ id: "UX-21", owner: "07-04 countdown cue port", automated_checks: Object.freeze(["src/ui/components/RestDock.test.tsx", "src/platform/notifications/restCountdownAudioPort.test.ts" ]), flows: Object.freeze(["phase7-workout-removal-audio"]), native_backstops: Object.freeze(["UI-B02"]) }),
  Object.freeze({ id: "UX-22", owner: "07-05 app icon assets", automated_checks: Object.freeze(["scripts/phase7-icon-assets.test.mjs", "scripts/check-cng-reproducible.sh" ]), flows: Object.freeze(["phase7-icon-navigation-accessibility"]), native_backstops: Object.freeze(["UI-B04"]) }),
  Object.freeze({ id: "UI-E01", owner: "07-02 set collections", automated_checks: Object.freeze(["src/ui/components/SetRow.test.tsx" ]), flows: Object.freeze(["phase7-today-settings", "phase7-workout-removal-audio"]), native_backstops: Object.freeze([]) }),
  ...
  Object.freeze({ id: "UI-E03", owner: "07-04 audio failure", automated_checks: Object.freeze(["src/ui/components/RestDock.test.tsx" ]), flows: Object.freeze(["phase7-workout-removal-audio"]), native_backstops: Object.freeze(["UI-B02"]) }),
  ...
  Object.freeze({ id: "UI-E05", owner: "07-02 and 07-03 partial rows", automated_checks: Object.freeze(["src/ui/components/SetRow.test.tsx", "src/ui/__tests__/OwnedPlanEditor.test.tsx" ]), flows: Object.freeze(["phase7-today-settings", "phase7-workout-removal-audio", "phase7-plan-schedule-reorder"]), native_backstops: Object.freeze([]) }),
  ...
  Object.freeze({ id: "UI-E07", owner: "07-02 and 07-03 cardinality", automated_checks: Object.freeze(["src/ui/components/SetRow.test.tsx", "src/ui/__tests__/ScheduleEditor.test.tsx" ]), flows: Object.freeze(["phase7-workout-removal-audio", "phase7-plan-schedule-reorder"]), native_backstops: Object.freeze([]) }),
  Object.freeze({ id: "UI-E08", owner: "07-01 through 07-05 long text", automated_checks: Object.freeze(["src/ui/__tests__/SettingsScreen.test.tsx", "src/ui/components/SetRow.test.tsx" ]), flows: Object.freeze(["phase7-today-settings", "phase7-workout-removal-audio", "phase7-plan-schedule-reorder", "phase7-icon-navigation-accessibility"]), native_backstops: Object.freeze(["UI-B03"]) }),
  ...
  Object.freeze({ id: "UI-B02", owner: "07-10 physical audio evidence", automated_checks: Object.freeze(["src/ui/components/RestDock.test.tsx" ]), flows: Object.freeze(["phase7-workout-removal-audio"]), native_backstops: Object.freeze(["N4"]) }),
  ...
  Object.freeze({ id: "UI-B04", owner: "07-10 launcher evidence", automated_checks: Object.freeze(["scripts/phase7-icon-assets.test.mjs" ]), flows: Object.freeze(["phase7-icon-navigation-accessibility"]), native_backstops: Object.freeze(["N4"]) }),
